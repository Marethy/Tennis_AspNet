using TennisWebMVCWeb.Models;
using TennisWebMVCWeb.Hubs;
using TennisWebMVCWeb.Intefaces;
using TennisWebMVCWeb.Models;
using TennisWebMVCWeb.Repositories;
...
builder.Services.AddDbContext<TennisWebMVCDbContext>(options => options.UseSqlServer(
